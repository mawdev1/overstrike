...
export const SETTINGS_INVENTORY = Object.freeze([
  ...
  bool('motionBlur', 'graphics', 'DEVICE', 'Motion blur', false, {
    readOnly: true,
    unavailableReason: 'the current renderer has no velocity buffer',
  }),
  ...
  choice('mode', 'input', 'PRACTICE', 'Practice mode', ['tdm', 'bomb', 'extraction'], 'tdm',
    { synonyms: ['team deathmatch', 'bomb', 'extraction', 'raid'] }),
]);
...
export const BINDING_ACTIONS = Object.freeze([
  ...
  action('tacticalEquipment', 'Tactical equipment', null, null, { unavailableReason: 'no tactical-equipment slot is shipped' }),
  ...
  action('textChat', 'Text chat', 'Enter', null, { unavailableReason: 'match text chat is not shipped' }),
  action('teamChat', 'Team chat', 'KeyY', null, { unavailableReason: 'match team chat is not shipped' }),
  action('tacticalPing', 'Tactical ping', 'Mouse3'),
  action('muteCurrentTarget', 'Mute current target', null, null, { unavailableReason: 'voice chat is not shipped' }),
