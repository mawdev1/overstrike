...
.os-settings button,.os-settings input,.os-settings select{min-height:44px}.os-settings button{border:1px solid var(--set-border);border-radius:2px;background:linear-gradient(105deg,#141c26,#0d131b);color:inherit;padding:.55rem .8rem;cursor:pointer;letter-spacing:.04em;transition:border-color 140ms ease,background 140ms ease,box-shadow 140ms ease}
.os-settings button:hover,.os-settings button:focus-visible{border-color:var(--set-accent);background:linear-gradient(105deg,#18231f,rgba(142,247,196,.08));box-shadow:inset 2px 0 var(--set-accent)}.os-settings button[aria-pressed=true],.os-settings .os-primary{background:linear-gradient(100deg,#b6ffdd,var(--set-accent));color:#04060a;border-color:var(--set-accent);box-shadow:0 0 1.5rem rgba(142,247,196,.15)}
.os-settings :focus-visible{outline:2px solid var(--set-accent);outline-offset:3px}.os-settings__header{display:flex;align-items:end;justify-content:space-between;gap:1rem;flex-wrap:wrap;border-bottom:1px solid var(--set-soft);padding-bottom:1rem}
.os-settings h1,.os-settings h2,.os-settings h3{font-family:var(--f-cond,"Arial Narrow"),system-ui,sans-serif;line-height:1.12;letter-spacing:.08em;text-transform:uppercase;margin:.25rem 0 .75rem}.os-settings__lede{color:var(--os-muted,#9db0c1);max-width:55ch}
.os-settings__search{display:grid;gap:.3rem;min-width:min(100%,19rem)}.os-settings__search input,.os-setting select,.os-setting input[type=number],.os-setting input[type=text]{background:#04070a;border:1px solid var(--set-soft);border-left-color:var(--set-border);border-radius:2px;color:inherit;padding:.55rem}
.os-settings__status{border:1px solid var(--set-soft);border-left:.3rem solid var(--os-warning,#ffb347);background:rgba(43,37,24,.72);padding:.75rem 1rem;margin:1rem 0}.os-settings__status[data-kind=conflict]{border-left-color:var(--os-danger,#ff4a35)}.os-settings__status[data-kind=synced]{border-left-color:var(--set-accent);background:rgba(19,61,47,.24)}
...
.os-setting{position:relative;background:linear-gradient(110deg,rgba(142,247,196,.035),transparent 35%),rgba(8,12,17,.88);border:1px solid var(--set-soft);border-left:2px solid var(--set-border);border-radius:0;padding:1rem;display:grid;grid-template-columns:minmax(12rem,1fr) minmax(15rem,1fr);align-items:center;gap:1rem;transition:border-color 140ms ease,background 140ms ease}.os-setting:hover{border-left-color:var(--set-accent);background:linear-gradient(110deg,rgba(142,247,196,.07),transparent 42%),rgba(8,12,17,.92)}
.os-setting__name{font-family:var(--f-cond,"Arial Narrow"),system-ui,sans-serif;font-weight:750;letter-spacing:.045em}.os-setting__meta{display:flex;gap:.45rem;align-items:center;flex-wrap:wrap;color:var(--os-muted,#9db0c1);font-size:.88rem}.os-scope{border:1px solid var(--set-border);border-radius:2px;background:rgba(142,247,196,.06);color:var(--set-accent);font-family:var(--f-mono,ui-monospace),monospace;font-size:.78rem;letter-spacing:.04em;padding:.1rem .5rem}
...
.os-setting__reset{min-width:44px}.os-binding__slots{display:flex;justify-content:flex-end;gap:.45rem;flex-wrap:wrap}.os-binding__slot{min-width:8.5rem}.os-binding__slot[data-unbound=true]{border-style:dashed;color:var(--os-muted,#9db0c1)}
.os-settings__empty,.os-diagnostics{border:1px dashed var(--set-border);border-radius:0;background:rgba(8,12,17,.62);padding:1.2rem;color:var(--os-muted,#9db0c1)}.os-capture{position:sticky;bottom:1rem;z-index:2;border:1px solid var(--set-accent);border-left:3px solid var(--set-accent);background:#080c11;padding:1rem;display:flex;justify-content:space-between;align-items:center;gap:1rem;box-shadow:0 0 2rem rgba(142,247,196,.1)}
.os-dialog-backdrop{position:fixed;inset:0;z-index:20;background:rgba(0,0,0,.8);display:grid;place-items:center;padding:1rem}.os-dialog{width:min(32rem,100%);background:linear-gradient(120deg,rgba(142,247,196,.07),transparent 42%),#080c11;border:1px solid var(--set-border);border-left:3px solid var(--set-accent);border-radius:0;padding:1.25rem;box-shadow:0 1rem 4rem #000,0 0 2rem rgba(142,247,196,.08)}
.os-dialog__actions{display:flex;justify-content:flex-end;gap:.5rem;flex-wrap:wrap;margin-top:1rem}.os-settings__danger{border-color:var(--os-danger,#ff4a35)!important}.os-settings__sr{position:absolute;width:1px;height:1px;overflow:hidden;clip:rect(0,0,0,0)}
